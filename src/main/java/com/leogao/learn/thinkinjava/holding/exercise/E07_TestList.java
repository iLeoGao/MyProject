...
public class E07_TestList {
   ...
   * Output: lst = [IDClass 0, IDClass 1, IDClass 2, IDClass 3, IDClass 4,
   * IDClass 5, IDClass 6, IDClass 7, IDClass 8, IDClass 9] subSet = [IDClass 2,
   * IDClass 3, IDClass 4] lst = [IDClass 0, IDClass 1, IDClass 5, IDClass 6,
