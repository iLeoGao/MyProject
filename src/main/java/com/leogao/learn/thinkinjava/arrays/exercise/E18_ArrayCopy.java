...
public class E18_ArrayCopy {
   ...
   * Output: a = [Sphere 0, Sphere 0, Sphere 0, Sphere 0] b = [null, null, null,
   * null] b = [Sphere 0, Sphere 0, Sphere 0, Sphere 0] a = [Sphere 0, Sphere 1,
   * Sphere 0, Sphere 1] b = [Sphere 0, Sphere 0, Sphere 0, Sphere 0] a =
   * [Sphere -1, Sphere 1, Sphere -1, Sphere 1] b = [Sphere -1, Sphere -1,
   * Sphere -1, Sphere -1]
   *///:~
