...
public class E16_SkipGenerator {
   ...
   * Output: a1 = [true, false, true, false, true, false] a2 = [0, 1, 2, 3, 4,
   * 5] a3 = [a, c, e, g, i, k] a4 = [0, 3, 6, 9, 12, 15] a5 = [0, 4, 8, 12, 16,
   * 20] a6 = [0, 5, 10, 15, 20, 25] a7 = [0.0, 1.5, 3.0, 4.5, 6.0, 7.5] a8 =
